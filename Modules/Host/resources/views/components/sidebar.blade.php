...
@php
    $navItems = [
        ['route' => 'host.dashboard',            'icon' => 'home',     'label' => 'Dashboard'],
        ['route' => 'host.properties.index',     'icon' => 'building', 'label' => 'My Properties'],
        ['route' => 'host.properties.create',    'icon' => 'plus',     'label' => 'Add Property'],
