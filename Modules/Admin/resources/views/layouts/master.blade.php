...
<head>
    ...
    <title>@yield('title', 'Admin Dashboard') — StayNest</title>
    <meta name="description" content="@yield('meta_description', 'Admin panel for StayNest.')">
        ...
        tailwind.config = {
            theme: {
                extend: {
                    ...
                    colors: {
                        brand:   { DEFAULT: '#ff385c', dark: '#d90b2e', light: '#ffe4e8' },
                        sidebar: { DEFAULT: '#0f172a', text: '#94a3b8', active: '#ff385c' },
                    },
                }
            }
        }
    ...
    <style>
        ...
        .nav-link.active { color: #fff; background: rgba(255,255,255,.10); font-weight: 600; }
        .nav-link.active svg { color: #ff385c; }
        ...
        .btn-primary:hover { box-shadow: 0 8px 24px rgba(255,56,92,.35); transform: translateY(-1px); }

        .btn-outline {
            border: 2px solid #e5e7eb; color: #374151; font-weight: 600;
...
<div class="flex h-full min-h-screen">
    ...
    <div class="flex-1 flex flex-col min-w-0">
        ...
        <footer class="border-t border-gray-100 px-8 py-4 text-xs text-gray-400 flex items-center justify-between">
            <span>© {{ date('Y') }} StayNest. Admin Panel.</span>
            <span>v1.0.0</span>
        </footer>
    </div>
</div>
