...
<header class="h-16 bg-white border-b border-gray-100 flex items-center justify-between px-4 sm:px-6 lg:px-8 gap-4 sticky top-0 z-20 shadow-sm">
    ...
    <nav class="hidden sm:flex items-center gap-2 text-sm text-gray-400 min-w-0">
        <a href="{{ route('admin.users.index') }}" class="hover:text-brand transition-colors font-medium">Admin</a>
    ...
    <div class="flex items-center gap-3 ml-auto">
        ...
        {{-- Avatar dropdown --}}
        <div class="relative">
            <button class="flex items-center gap-2 border border-gray-200 rounded-xl py-1.5 px-2.5 hover:border-brand transition-colors">
